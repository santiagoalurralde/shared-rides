...
$( document ).ready(function() {
	...
	$( "#nextBtn" ).click(function(){
		if(i===0){	
			$( "#imgLeft" ).attr('src','resources/images/sun.png'); 
			$( "#imgRight" ).attr('src','resources/images/moon.png');
			$( "#backBtn" ).show( "slow" );
		}
		if(i===1){
			$( "#imgRight" ).hide( 0 );
			$( "#imgLeft" ).replaceWith( '<iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.ar/?ie=UTF8&amp;ll=-31.394821,-64.201698&amp;spn=0.074584,0.169086&amp;t=h&amp;z=13&amp;output=embed"></iframe>' );
			//''
			$( this ).hide( "slow" );
		}
	});
	...
	$( "#backBtn" ).click(function(){
		...
		if(i===-1){
			$( "#imgLeft" ).attr('src','resources/images/boot.png'); 
			$( "#imgRight" ).attr('src','resources/images/steering.png');
			$( this ).hide( "slow" );
		}
	});
