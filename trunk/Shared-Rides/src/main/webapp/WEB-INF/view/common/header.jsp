...
<div id="nav" class="theBox">
    ...
    <ul>       
        ...
        <li>					<a href="people.do">       			<spring:message code="label.people"																/></a> <img id="alertIcon" src="resources/images/bell.png" width="18px" style="position: absolute; left: 54%; top: 12px "/></li>
